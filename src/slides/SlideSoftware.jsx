...
const BADGES = [
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#00B4D8" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
...
export default function SlideSoftware({ isActive }) {
  ...
  useEffect(() => {
    ...
    tl.to(circleRef.current, { opacity: 1, scale: 1, duration: 1.2, ease: "expo.out" }, 0.3);

    gsap.set(photoTopRef.current, { opacity: 0, scale: 0.5, y: 30 });
    tl.to(photoTopRef.current, { opacity: 1, scale: 1, y: 0, duration: 0.9, ease: "back.out(1.4)" }, 0.7);

    gsap.set(photoRightRef.current, { opacity: 0, scale: 0.5, x: 30 });
    tl.to(photoRightRef.current, { opacity: 1, scale: 1, x: 0, duration: 0.9, ease: "back.out(1.4)" }, 0.85);

    gsap.set(photoLeftRef.current, { opacity: 0, scale: 0.5, x: -30 });
    tl.to(photoLeftRef.current, { opacity: 1, scale: 1, x: 0, duration: 0.9, ease: "back.out(1.4)" }, 1.0);

    if (badgesRef.current) {
      gsap.set(badgesRef.current.children, { opacity: 0, scale: 0.6, y: 15 });
      tl.to(badgesRef.current.children, { opacity: 1, scale: 1, y: 0, duration: 0.6, stagger: 0.1, ease: "back.out(1.8)" }, 0.9);
    }
      ...
      <div style={S.container}>
        ...
        <div style={S.bodyRow}>
              ...
              {FEATURES.map((feat, i) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 8px 28px rgba(0,140,216,0.12)";
                    e.currentTarget.style.borderColor = "rgba(0,180,216,0.25)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "translateY(0)";
                    e.currentTarget.style.boxShadow = "0 2px 12px rgba(0,0,0,0.04)";
                    e.currentTarget.style.borderColor = "rgba(0,180,216,0.08)";
                  }}
                >
          ...
          <div style={S.rightCol}>
            <div style={S.circleComposition}>
              {/* Decorative rings */}
              <div style={S.decoRing1} />
              <div style={S.decoRing2} />

              {/* Center dark circle with logo */}
              <div ref={circleRef} style={S.centerCircle}>
                <div style={S.centerGlow} />
                <div style={S.centerInner}>
                  <img src="/LOGOIMG.png" alt="NexGravision" style={S.centerLogoImg} />
                  <div style={S.centerLogoText}>NEXGRAVISION</div>
                </div>
              </div>

              {/* Photo: Top-right - woman on laptop */}
              <div ref={photoTopRef} style={S.photoTopRight}>
              ...
              {/* Photo: Right - developer coding */}
              <div ref={photoRightRef} style={S.photoRight}>
                <div style={S.photoFrame}>
                  <img
              ...
              {/* Photo: Left - workspace */}
              <div ref={photoLeftRef} style={S.photoLeft}>
                <div style={S.photoFrame}>
                  <img
              ...
              {/* Floating Badges */}
              <div ref={badgesRef} style={S.badgesContainer}>
                {BADGES.map((badge, i) => (
                  <div
                    key={i}
                    style={{ ...S.floatingBadge, ...badge.style }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "scale(1.06)";
                      e.currentTarget.style.boxShadow = "0 10px 35px rgba(0,140,216,0.15)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    <div style={{ ...S.badgeIconCircle, background: badge.iconBg, borderColor: badge.iconBorder }}>
                      {badge.icon}
                    </div>
                    <div style={S.badgeTextCol}>
...
const S = {
  ...
  centerGlow: {
    ...
    boxShadow: "0 0 35px rgba(0,180,216,0.35), 0 0 70px rgba(0,180,216,0.15), inset 0 0 25px rgba(0,180,216,0.1)",
    pointerEvents: "none",
  },
  centerInner: {
    display: "flex",
  ...
  photoFrame: {
    width: "clamp(90px, 10.5vw, 145px)",
    height: "clamp(90px, 10.5vw, 145px)",
    borderRadius: "50%",
    overflow: "hidden",
